...
var Link = function (_a) {
    ...
    var routerLocale = (0, router_1.useRouter)().locale;
    var locale = propLocale || routerLocale || (0, getEnv_1.getDefaultLocale)() || (0, getEnv_1.getLocales)()[0];
    ...
    if (!propLocale && typeof href === 'string' && unPrefixedHref !== href) {
        ...
        if (hrefLocale && (0, getEnv_1.getLocales)().includes(hrefLocale)) {
            locale = hrefLocale;
        }
    }
    return (react_1.default.createElement(link_1.default, __assign({ href: unPrefixedHref, as: as || (0, translateUrl_1.translateUrl)(href, locale, { format: 'string' }), locale: locale }, props)));
};
exports.Link = Link;
